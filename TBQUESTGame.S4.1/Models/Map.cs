...
namespace TBQUESTGame.Models
{
    public class Map
    {
        ...
        public void ResetLocationPalm()
        {
            _currentLocationCoordinates.Row = 0;
            _currentLocationCoordinates.Column = 0;
        }
        ...
        public void UpdateLocationAccesible(Player player)
        {
            ...
            else if(_currentLocationCoordinates.Row > 0)
            {
                Location nextNorthLocation = _mapLocations[_currentLocationCoordinates.Row - 1, _currentLocationCoordinates.Column];
                ...
                if (nextNorthLocation != null)
                {
                    ...
                    northLocaion = nextNorthLocation;
                }
            }
